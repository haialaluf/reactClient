...
class Wizard extends Component {
    ...
    renderBreadCrumbs(stages, wizard) {
        const isState = (state) => this.state.currentState === state;
        return (
            <BreadCrumbs show={ this.state.reachedState } >
                ...
                <div className="pointer" onClick={ () => this.nextState.bind(this)(wizard) }>
                    <div>{this.state.currentState === stages.length? 'Done' : 'Next' } </div>
                </div>
            </BreadCrumbs>
        )
    }
    ...
    render() {
        ...
        if (wizard.items) {
            return (
                <div>
                    { this.renderBreadCrumbs(stages, wizard) }
                    { this.state.currentState !== stages.length ? this.renderItems(items) : '' }
